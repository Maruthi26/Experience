...
if(isset($_POST['name'])){
    ...
    $sql = "INSERT INTO `experience`.`experience` ( `name`, `grade`, `section`, `email`, `phone`, `experience`, `date&time`) VALUES ('$name', '$grade', '$section', '$email', '$phone', '$experience', current_timestamp());";
    //echo $sql;
